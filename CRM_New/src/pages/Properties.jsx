...
const initialProperties = [
  {
    id: 1,
    title: 'Apt 302 - Edifício Lumiere',
    price: 850000,
    location: 'Jardins, São Paulo - SP',
    type: 'Apartamento',
    status: 'Disponível',
    description: 'Apartamento luxuoso com 3 suítes, vista panorâmica, 2 vagas de garagem. Acabamento premium, varanda gourmet.',
    broker: 'Admin',
    bedrooms: 3,
    area: 142,
  },
  {
    id: 2,
    title: 'Casa Alphaville Premium',
    price: 2400000,
    location: 'Alphaville, Barueri - SP',
    type: 'Casa',
    status: 'Disponível',
    description: 'Casa em condomínio fechado, 4 suítes, piscina aquecida, área gourmet completa. Terreno de 500m².',
    broker: 'Admin',
    bedrooms: 4,
    area: 380,
  },
  {
    ...
    type: 'Cobertura',
    status: 'Reservado',
    description: 'Cobertura duplex com terraço privativo, 4 suítes, vista 360°. Lazer completo no condomínio.',
    broker: 'Admin',
    bedrooms: 4,
    area: 290,
  },
  {
    ...
    type: 'Comercial',
    status: 'Disponível',
    description: 'Sala comercial de 80m² em edifício corporativo premium. Recepção, 2 banheiros, copa.',
    broker: 'Admin',
    bedrooms: 0,
    area: 80,
  },
  {
    ...
    type: 'Terreno',
    status: 'Vendido',
    description: 'Terreno plano de 1.200m² em condomínio fechado com infraestrutura completa.',
    broker: 'Admin',
    bedrooms: 0,
    area: 1200,
  },
